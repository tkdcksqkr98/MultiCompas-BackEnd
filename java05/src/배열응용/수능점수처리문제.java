...
public class 수능점수처리문제 {

	public static void main(String[] args) {
//		수능 10000명의 점수를 처리! ==> 배열필요
...
//		랜덤으로 10000명의 넣어주세요. Random필요
		...
		System.out.println("수능 만점자는 " + maxCount + "명 입니다.");
		System.out.println("수능 0점자는 " + zeroCount + "명 입니다.");
		...
		System.out.println("수능점수의 평균: " + avg);
