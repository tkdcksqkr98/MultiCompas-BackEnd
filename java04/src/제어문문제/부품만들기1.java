...
public class 부품만들기1 {
	public static void main(String[] args) {
		...
		text5.setText("전화번호 입력");

		JLabel text3 = new JLabel(); //글씨
		text3.setText("회원가입처리");
		...
		text3.setBackground(Color.red); //배경색
		text3.setForeground(Color.white); //버튼의 위색, 글자색
		text4.setBackground(Color.red); //배경색
		text4.setForeground(Color.white); //버튼의 위색, 글자색
		text5.setBackground(Color.red); //배경색
		text5.setForeground(Color.white); //버튼의 위색, 글자색
